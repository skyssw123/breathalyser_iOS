...
@objc protocol BLEPeripheralDelegate: Any {
...
@objc public class BLEPeripheral: NSObject, CBPeripheralDelegate {
    ...
    @objc init(peripheral:CBPeripheral, delegate:BLEPeripheralDelegate){
    ...
    @objc public func writeString(string:NSString){
    ...
    @objc public func writeRawData(data:NSData) {
...
//        
//        var characteristicUUIDstring = "6e400002-b5a3-f393-e0a9-e50e24dcca9e"
//        var characteristicUUID = CBUUID(string: characteristicUUIDstring);
//        
//        txCharacteristic = CBMutableCharacteristic.init(type: characteristicUUID, properties: CBCharacteristicProperties.Write, value: nil, permissions: CBAttributePermissions.Readable)
//        
...
//        txCharacteristic = [[CBMutableCharacteristic alloc] initWithType:characteristicUUID properties:CBCharacteristicPropertyRead|CBCharacteristicPropertyWrite value:data permissions:CBAttributePermissionsReadable|CBAttributePermissionsWriteable];
//        
...
//            delegate.connectionMode == ConnectionMode.DFU {
    ...
    @objc func handleError(errorString:String) {
